    ...
    <div class="wrapper ">
        <div class="sidebar" data-color="azure" data-background-color="white" data-image="../assets/img/sidebar-1.jpg">
            <div class="logo" style="margin-left: 60px;">
                <img src="{{ asset('dashboard/images/dwibagus.png')}}" alt="dwibagus" style="width: 100px; height:40px;">
            </div>
            ...
            <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse justify-content-end">
                        <img src="https://ui-avatars.com/api/?name={{Auth::user()->name}}" alt="foto" width="40" , class="mr-2 rounded-circle">
